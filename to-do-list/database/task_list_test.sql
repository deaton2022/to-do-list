drop database if exists task_list_test;

create database task_list_test;
use task_list_test;
...
INSERT INTO task (importance_id, task_name, task_description, due_date,app_user_id)
	values
  (1,"Udemy Course","Finish Angie's Udemy Course", "2023-09-10",1);
